...
const OrdersTable = ({ classes }) => {
  ...
  const columns = [
    {
      ...
      renderCell: (params) => dataFormat.dateTimeFormatter(params.row),
      ...
      <div>
        ...
        >
          <MenuItem
            classes={classes}
            onClick={() => {
              history.push(`/admin/orders/${cell.id}/edit`);
              handleClose();
            }}
          >
            <EditIcon />
  ...
  return (
    <div>
      <Widget title={<h4>Orders</h4>} disableWidgetMenu>
